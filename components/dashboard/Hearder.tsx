    ...
    return (
        <nav className="sticky top-0 z-50 border-b border-[#cfcfcf9d]  flex justify-between items-center w-full bg-white  h-[75px] px-4 md:px-32">
            ...
            <ul className="hidden xl:flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                ...
                <li className="me-2">
                    <Link href="/dashboard/patients" className={pathname === "/dashboard/patients"|| pathname.includes("/dashboard/patients") ? "inline-flex items-center justify-center p-4 border-b-2 border-[#276DF7] rounded-t-lg text-[#276DF7] hover:border-[#276DF7] group" : "inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-[#276DF7] hover:border-[#276DF7] group"}>
                        <svg className={pathname === "/dashboard/patients" || pathname.includes("/dashboard/patients") ? "w-4 h-10 me-2 text-[#276DF7] group-hover:text-[#276DF7]" : "w-4 h-10 me-2 text-gray-400 group-hover:text-[#276DF7]"} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
